...
import com.frank.practicehilt.BuildConfig
...
object NetworkModule {
    ...
    fun provideRetrofitStackOverFlow(
        ...
        return Retrofit.Builder().addConverterFactory(moshiConverterFactory).baseUrl(Config.StackOverFlowUrl).client(okHttpClient).build()
    }
